...
//	@Query(value = "SELECT * FROM DefectLocation l INNER JOIN VehicleDefect d ON d.id = l.vehicleDefect.id"
//			+ " INNER JOIN Vehicle v ON v.id = d.vehicle.id WHERE v.id = :vehicleId",
//			nativeQuery=true)
